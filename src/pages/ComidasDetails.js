...
import { ShareButton, FavoriteButton } from '../components';
...
function ComidasDetails(props) {
  ...
  const requestAPI = useContext(appProvider);
  ...
  const getValuesInObject = (obj, value) => Object.keys(obj).filter((key) => key.includes(value));
  ...
  return (
    <div>
      ...
      <div className="video">
        {/* <video data-testid="video" src={meals[0].strYoutube} /> */}
      </div>
      <div className="carousel-recomentations">
        <h3>Recomendadas</h3>
        {/* {
